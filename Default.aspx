...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" Runat="Server">
    <h1 class="text-center mb-gutter-2"><img src="<%= (New SI_UTIL).getImg("logos/select-interactive-500w.v1.webp", "png")%>" class="dpi" alt="Select Interactive Website Development" width="500" height="151" /></h1>
