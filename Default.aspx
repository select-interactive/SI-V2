...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" Runat="Server">
    <h1 class="text-center mb-gutter-2"><img src="//static.select-interactive.com/img/logos/select-interactive-500w.v1.<%= IIf(Session("webP") = True, "webp", "png")%>" class="dpi" alt="Select Interactive Website Development" width="500" height="151" /></h1>
