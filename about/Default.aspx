...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" Runat="Server">
    ...
    <div class="row cols-2 divider">
        <div class="col">
            ...
            <img src="/img/about/headshots/jeremy-burton.v1.jpg" class="headshot" alt="Jeremy Burton" width="125" height="125" />
            ...
            <p>Jeremy was recently 1 of 200 developers world-wide selected to attend <a href="/news/2013/10/select-interactive-attends-edge-conference-nyc" target="_blank">Edge Conf 2013 - NYC</a>, a conference focusing on advanced, cutting-edge web technologies. All attendees were handpicked based on experience, knowledge to share, and desire to learn. After attending Edge Conf, Jeremy has since been <a href="/news/2013/11/i-get-to-attend-the-first-ever-chrome-dev-summit" target="_blank">invited to attend the first ever Chrome Dev Summit</a> in Mountain View, CA.</p>
